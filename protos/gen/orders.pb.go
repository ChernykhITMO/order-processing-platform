...
const file_orders_proto_rawDesc = "" +
	...
	"\x05items\x18\x02 \x03(\v2\x14.orders.v1.OrderItemR\x05items\"X\n" +
	"\x13CreateOrderResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12&\n" +
	"\x05order\x18\x02 \x01(\v2\x10.orders.v1.OrderR\x05order\",\n" +
	...
	"\x06status\x18\x01 \x01(\x0e2\x16.orders.v1.OrderStatusR\x06status*z\n" +
...
var file_orders_proto_depIdxs = []int32{
	...
	12, // 4: orders.v1.Order.created_at:type_name -> google.protobuf.Timestamp
	12, // 5: orders.v1.Order.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 6: orders.v1.CreateOrderRequest.items:type_name -> orders.v1.OrderItem
	3,  // 7: orders.v1.CreateOrderResponse.order:type_name -> orders.v1.Order
	3,  // 8: orders.v1.GetOrderResponse.order:type_name -> orders.v1.Order
	0,  // 9: orders.v1.ListOrdersRequest.status:type_name -> orders.v1.OrderStatus
	3,  // 10: orders.v1.ListOrdersResponse.orders:type_name -> orders.v1.Order
	0,  // 11: orders.v1.CancelOrderResponse.status:type_name -> orders.v1.OrderStatus
	4,  // 12: orders.v1.OrdersService.CreateOrder:input_type -> orders.v1.CreateOrderRequest
	6,  // 13: orders.v1.OrdersService.GetOrder:input_type -> orders.v1.GetOrderRequest
	8,  // 14: orders.v1.OrdersService.ListOrders:input_type -> orders.v1.ListOrdersRequest
	10, // 15: orders.v1.OrdersService.CancelOrder:input_type -> orders.v1.CancelOrderRequest
	5,  // 16: orders.v1.OrdersService.CreateOrder:output_type -> orders.v1.CreateOrderResponse
	7,  // 17: orders.v1.OrdersService.GetOrder:output_type -> orders.v1.GetOrderResponse
	9,  // 18: orders.v1.OrdersService.ListOrders:output_type -> orders.v1.ListOrdersResponse
	11, // 19: orders.v1.OrdersService.CancelOrder:output_type -> orders.v1.CancelOrderResponse
